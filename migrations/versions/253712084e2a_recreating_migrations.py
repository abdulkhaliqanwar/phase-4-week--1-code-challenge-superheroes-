...
Revision ID: 253712084e2a
Revises: 
Create Date: 2025-04-01 16:51:36.488643
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('strength', sa.Enum('STRONG', 'WEAK', 'AVERAGE', name='strengthenum'), nullable=False),
